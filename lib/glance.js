    ...
    _createClass(Glance, [{
        ...
        value: function find(selector) {
            ...
            return this.getCustomLabeledElements(selector).then(function (labels) {
                return _this19.glanceElement(selector, labels).then(function (cssIds) {

                    return _this19.webdriver.element(cssIds).then(function (res) {
                        return _this19.webdriver.execute(_client.waitForChange, res.value, "data-glance-wait-for-change");
                    }).then(function (res) {
                        if (res.value == null) {
