...
var Glance = function () {
    function Glance(config) {
        ...
        this.promise = new _es6Promise.Promise(function (resolve, reject) {
            ...
            if (config.wdio) {
                ...
                _this.wdio = _webdriverio2.default.remote(config).init();
            }

            _this.wdio.init(resolve);
        });
    }
    ...
    _createClass(Glance, [{
        ...
        value: function execute(func) {
            ...
            return this.wrapPromise(function () {
                return _this11.webdriverio().execute(func, args);
            });
        }
        ...
        value: function convertGlanceSelector(reference) {
            ...
            return new _es6Promise.Promise(function (resolve, reject) {
                return _this13.getCustomLabeledElements(reference).then(function (labels) {
                    return _this13.glanceElement(reference, labels).then(function (id) {
        ...
        value: function convertGlanceSelectors(reference) {
            ...
            return new _es6Promise.Promise(function (resolve, reject) {
                return _this14.getCustomLabeledElements(reference).then(function (labels) {
                    return _this14.glanceElement(reference, labels, true).then(function (ids) {
        ...
        value: function then(onFulfilled, onRejected) {
            ...
            this.promise = new _es6Promise.Promise(function (resolve, reject) {
                _this15.promise.then(function (value) {
                    resolve(onFulfilled.call(new Glance(_this15), value));
                }, function (reason) {
                    reject(onRejected.call(new Glance(_this15), reason));
                });
            });
        ...
        value: function _catch(onRejected) {
            ...
            this.promise = new _es6Promise.Promise(function (resolve, reject) {
                _this16.promise.then(resolve, function (reason) {
