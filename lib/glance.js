...
var Glance = function () {
    ...
    _createClass(Glance, [{
        ...
        value: function then(onFulfilled, onRejected) {
            ...
            this.promise = new Promise(function (resolve, reject) {
                _this19.promise.then(function (value) {
                    resolve(onFulfilled.call(new Glance(_this19), value));
                }, function (reason) {
                    reject(onRejected.call(new Glance(_this19), reason));
                });
            });
        ...
        value: function _catch(onRejected) {
            ...
            this.promise = new Promise(function (resolve, reject) {
                _this20.promise.then(resolve, function (reason) {
                    reject(onRejected.call(new Glance(_this20), reason));
                });
            });
