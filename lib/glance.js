...
var Glance = function () {
    function Glance(config) {
        ...
        this.promiseUtils = new _promiseUtils2.default(new Promise(function (resolve, reject) {
            ...
            if (config.webdriver) {
                ...
                _this.addClientModifierFunc = config.addClientModifierFunc || _client.emptyClientFunction;
                _this.webdriver = config.webdriver;
                resolve();
            } else if (config.driverConfig) {
                _this.customLabels = {};
                _this.addClientModifierFunc = _client.emptyClientFunction;
    ...
    _createClass(Glance, [{
        ...
        key: 'addClientModifiers',
        value: function addClientModifiers(addClientModifierFunc) {
        ...
        value: function get(selector) {
            ...
            return this.wrapPromise(function () {
                if (_this16.customLabels[selector] && _this16.customLabels[selector].get) {
                    return Promise.resolve(_this16.customLabels[selector].get(g));
                } else {
        ...
        value: function set(selector) {
            ...
            var g = new Glance(this);
            return this.wrapPromise(function () {
                if (_this17.customLabels[selector] && _this17.customLabels[selector].set) {
                    return Promise.resolve(_this17.customLabels[selector].set.apply(_this17, [].concat(g, values)));
                } else {
        ...
        value: function addGetter(label, lookup) {
            ...
            return this.wrapPromise(function () {
                if (_this18.customLabels[label]) _this18.customLabels[label].get = lookup;else _this18.customLabels[label] = { get: lookup };
        ...
        value: function addSetter(label, lookup) {
            ...
            return this.wrapPromise(function () {
                if (_this19.customLabels[label]) _this19.customLabels[label].set = lookup;else _this19.customLabels[label] = { set: lookup };
        ...
        value: function execute(func) {
            ...
            return this.wrapPromise(function () {
                return _this20.webdriver.execute(func, args);
            });
        }
        ...
        value: function glanceElement(selector, resolvedLabels, multiple) {
            ...
            return this.webdriver.execute(_glanceSelector2.default).then(function () {
                ...
                return _this21.webdriver.execute(_this21.addClientModifierFunc).then(function (res) {
                    return _this21.webdriver.execute(_client.GlanceSelector, selector, resolvedCustomLabels, multiple, logLevel).then(function (res) {
                        ...
                        return _this21.webdriver.execute(_client.tagElementWithID, val, ids).then(function () {
        ...
        value: function getCustomLabeledElements(reference) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var data = _this22.parse(reference);
                var labels = data.map(function (r) {
                    return r.label;
                });

                var foundLabels = labels.filter(function (label) {
                    return _this22.customLabels[label] && typeof _this22.customLabels[label].locator == 'function';
                });

                var resolvedCustomLabels = {};
                foundLabels.resolveSeries(function (key) {
                    var g = new Glance(_this22);

                    return Promise.resolve(_this22.customLabels[key].locator(g, key)).then(function (element) {
        ...
        value: function find(selector) {
            ...
            return this.getCustomLabeledElements(selector).then(function (labels) {
                return _this23.glanceElement(selector, labels);
            });
        }
    }, {
        key: 'then',
