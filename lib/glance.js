    ...
    _createClass(Glance, [{
        ...
        value: function glanceElement(selector, resolvedLabels, multiple) {
            ...
            return this.browser.execute(_glanceSelector2.default).then(function () {
                return _this17.browser.execute(_client.GlanceSelector, selector, mergedLabels, multiple, logLevel).then(function (res) {
                    ...
                    return _this17.browser.execute(_client.tagElementWithID, val, ids)
                    //return Promise.resolve()
                    .then(function () {
        ...
        value: function convertGlanceSelector(reference) {
            ...
            return this.getCustomLabeledElements(reference).then(function (labels) {
                return _this19.glanceElement(reference, labels).then(function (cssIds) {
                    return _this19.browser.element(cssIds).then(function (res) {
                        return _this19.browser.execute(_client.waitForChange, res.value, "data-glance-wait-for-change");
                    }).then(function (res) {
                        if (res.value == null) {
