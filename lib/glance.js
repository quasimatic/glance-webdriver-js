...
var Glance = function () {
    ...
    _createClass(Glance, [{
        ...
        value: function cast(state) {
            var c = new _cast2.default(new Glance(this));
        ...
        value: function type(text) {
            ...
            return this.wrapPromise(function () {
                return _this4.webdriverio.keys(text);
            });
        }
    }, {
        key: 'click',
        value: function click(selector) {
            ...
            return this.wrapPromise(function () {
                return _this5.convertGlanceSelector(selector).then(function (wdioSelector) {
                    return _this5.webdriverio.click(wdioSelector);
                });
            });
        }
    }, {
        ...
        value: function doubleClick(selector) {
            ...
            return this.wrapPromise(function () {
                return _this6.convertGlanceSelector(selector).then(function (wdioSelector) {
                    return _this6.webdriverio.doubleClick(wdioSelector);
                });
            });
        }
    }, {
        ...
        value: function middleClick(selector) {
            ...
            return this.wrapPromise(function () {
                return _this7.convertGlanceSelector(selector).then(function (wdioSelector) {
                    return _this7.webdriverio.middleClick(wdioSelector);
                });
            });
        }
    }, {
        ...
        value: function rightClick(selector) {
            ...
            return this.wrapPromise(function () {
                return _this8.convertGlanceSelector(selector).then(function (wdioSelector) {
                    return _this8.webdriverio.rightClick(wdioSelector);
                });
            });
        }
    }, {
        ...
        value: function moveMouseTo(selector, xOffset, yOffset) {
            ...
            return this.wrapPromise(function () {
                return _this9.convertGlanceSelector(selector).then(function (wdioSelector) {
                    return _this9.webdriverio.moveToObject(wdioSelector, xOffset, yOffset);
                });
            });
        }
    }, {
        ...
        value: function mouseDown() {
            ...
            return this.wrapPromise(function () {
                return _this10.webdriverio.buttonDown(0);
            });
        }
    }, {
        key: 'mouseUp',
        value: function mouseUp() {
            ...
            return this.wrapPromise(function () {
                return _this11.webdriverio.buttonUp(0);
            });
        }
    }, {
        key: 'dragAndDrop',
        value: function dragAndDrop(sourceSelector, targetSelector, xOffset, yOffset) {
            ...
            return this.wrapPromise(function () {
                return Promise.all([_this12.convertGlanceSelector(sourceSelector), _this12.convertGlanceSelector(targetSelector)]).then(function (result) {
                    if (_this12.webdriverio.isMobile) {
                        return _this12.webdriverio.getLocation(sourceElem).then(function (location) {
                            return _this12.webdriverio.touchDown(location.x, location.y);
                        }).getLocation(destinationElem).then(function (location) {
                            return _this12.webdriverio.touchMove(location.x, location.y).touchUp(location.x, location.y);
                        });
                    }

                    return _this12.webdriverio.moveToObject(result[0]).buttonDown().moveToObject(result[1], xOffset, yOffset).buttonUp();
                });
            });
        }
    }, {
        ...
        value: function pause(delay) {
            ...
            return this.wrapPromise(function () {
                return _this13.webdriverio.pause(delay);
            });
        }
        ...
        value: function watchForChange(selector) {
            ...
            return this.wrapPromise(function () {
                return _this14.convertGlanceSelector(selector).then(function (wdioSelector) {
                    return _this14.webdriverio.selectorExecute(wdioSelector, function (elements) {
        ...
        value: function waitForChange(selector) {
            ...
            return this.wrapPromise(function () {
                return _this15.convertGlanceSelector(selector).then(function (wdioSelector) {
                    return _this15.webdriverio.getAttribute(wdioSelector, "data-glance-wait-for-change").then(function (res) {
        ...
        value: function addLabel(label, func) {
            ...
            return this.wrapPromise(function () {
                _this16.customLabels[label] = func;
                return Promise.resolve();
            });
        }
        ...
        value: function execute(func) {
            ...
            return this.wrapPromise(function () {
                return _this17.webdriverio.execute(func, args);
            });
        }
        ...
        value: function convertGlanceSelector(reference) {
            ...
            return this.getCustomLabeledElements(reference).then(function (labels) {
                return _this19.glanceElement(reference, labels).then(function (cssIds) {
                    return _this19.webdriverio.getAttribute(cssIds, "data-glance-wait-for-change").then(function (res) {
                        if (res == null) {
        ...
        value: function convertGlanceSelectors(reference) {
            ...
            return new Promise(function (resolve, reject) {
                return _this20.getCustomLabeledElements(reference).then(function (labels) {
                    return _this20.glanceElement(reference, labels, true).then(function (cssIds) {
                        resolve(cssIds);
                    }).catch(function (reason) {
        ...
        value: function _waitForThen(resolve, reject) {
            ...
            this.promise = this.promise.then(function (value) {
                return resolve.call(new Glance(_this21), value);
            }, function (reason) {
                return reject.call(new Glance(_this21), reason);
            });
            ...
            return func().catch(function (reason) {
                if (retryCount <= 3) {
                    ...
                    return delay(delayAmount).then(function () {
                        return _this23._retryingPromise(func, ++retryCount);
                    });
                } else {
