...
var _glanceParser = require('../lib/glance-parser');
...
var Glance = function () {
    ...
    _createClass(Glance, [{
        ...
        value: function parse(reference) {
            return _glanceParser2.default.parse(reference);
        }
    }, {
        key: 'setLogLevel',
        ...
        value: function glanceElement(selector, customLabels, multiple) {
            return this.webdriverio.execute(_client2.default, selector, customLabels, multiple, this.logLevel).then(function (res) {
                var val = res.value;
        ...
        value: function getCustomLabeledElements(reference) {
            ...
            return new Promise(function (resolve, reject) {
                var data = _this16.parse(reference);
                var labels = data.containers.map(function (r) {
                    return r.label;
                });
        ...
        value: function _waitForThen(resolve, reject) {
            ...
            this.promise = this.promise.then(function (value) {
                return resolve.call(new Glance(_this19), value);
            }, function (reason) {
                return reject.call(new Glance(_this19), reason);
            });
        ...
        value: function _waitForCatch(reject) {
            ...
            this.promise = this.promise.catch(function (reason) {
                return reject.call(new Glance(_this20), reason);
            });
            return this;
        }
    }, {
            ...
            return func().catch(function (reason) {
                if (retryCount <= 3) {
                    ...
                    return delay(delayAmount).then(function () {
                        return _this21._retryingPromise(func, ++retryCount);
                    });
                } else {
