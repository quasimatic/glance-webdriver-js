...
var Glance = function () {
    ...
    _createClass(Glance, [{
        ...
        value: function execute(func) {
            ...
            return this.wrapPromise(function () {
                return _this13.webdriverio.execute(func, args);
            });
        }
        ...
        value: function convertGlanceSelector(reference) {
            ...
            return new Promise(function (resolve, reject) {
                return _this15.getCustomLabeledElements(reference).then(function (labels) {
                    return _this15.glanceElement(reference, labels).then(function (id) {
        ...
        value: function convertGlanceSelectors(reference) {
            ...
            return new Promise(function (resolve, reject) {
                return _this16.getCustomLabeledElements(reference).then(function (labels) {
                    return _this16.glanceElement(reference, labels, true).then(function (ids) {
        ...
        value: function then(onFulfilled, onRejected) {
            ...
            this.promise = new Promise(function (resolve, reject) {
                _this17.promise.then(function (value) {
                    resolve(onFulfilled.call(new Glance(_this17), value));
                }, function (reason) {
        ...
        value: function _catch(onRejected) {
            ...
            this.promise = new Promise(function (resolve, reject) {
                _this18.promise.then(resolve, function (reason) {
                    reject(onRejected.call(new Glance(_this18), reason));
                });
            });
