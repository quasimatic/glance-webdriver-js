...
var Glance = function () {
    ...
    _createClass(Glance, [{
        ...
        value: function execute(func) {
            ...
            return this.wrapPromise(function () {
                return _this16.webdriverio.execute(func, args);
            });
        }
        ...
        value: function convertGlanceSelector(reference) {
            ...
            return this.getCustomLabeledElements(reference).then(function (labels) {
                return _this18.glanceElement(reference, labels).then(function (cssIds) {
                    return _this18.webdriverio.getAttribute(cssIds, "data-glance-wait-for-change").then(function (res) {
                        if (res == null) {
        ...
        value: function _waitForThen(resolve, reject) {
            ...
            this.promise = this.promise.then(function (value) {
                return resolve.call(new Glance(_this20), value);
            }, function (reason) {
            ...
            return func().catch(function (reason) {
                if (retryCount <= 3) {
                    ...
                    return delay(delayAmount).then(function () {
                        return _this22._retryingPromise(func, ++retryCount);
                    });
                } else {
