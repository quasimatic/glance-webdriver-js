    ...
    (function e(t, n, r) {
        function s(o, u) {
            ...
            function _classCallCheck(e, n) {
                ...
                function e(n) {
                    _classCallCheck(this, e), this.findElement = n, this.customLabels = {};
                }return _createClass(e, [{ key: "search", value: function value(e, n, t, r) {
                        t = t || 0;for (var a = e[t], i = a.position - 1, o = [], s = n; s && 0 == o.length;) {
                            o = this.findElement(a.label, s, r), s = s.parentNode;
                        }o = this._limitToReferences(o, n);var c = t + 1 === e.length;if (c) return i >= 0 ? o[i] ? [].concat(o[i]) : [] : o;var u = [];if (i >= 0) {
                            var l = o[i],
                                f = this.search(e, l, t + 1, r);u = u.concat(f);
                        } else for (var h = 0; h < o.length; h++) {
                            var l = o[h],
                                f = this.search(e, l, t + 1, r);u = u.concat(f);
                        }return this._unique(u);
                    } }, { key: "_limitToReferences", value: function value(e, n) {
                        for (var t = !1, r = [], a = 0; a < e.length; ++a) {
                            this._isDescendant(e[a], n) && (t = !0, r.push(e[a]));
                        }return t ? r : e;
                    } }, { key: "_unique", value: function value(e) {
                        return e.filter(function (n, t) {
                            return e.indexOf(n) === t;
                        });
                    } }, { key: "_isDescendant", value: function value(e, n) {
            ...
            function _interopRequireDefault(e) {
                ...
                var r = {};r.customLabels = e.customLabels || {}, r.containerStrategy = e.containerStrategy;var t = function t(e) {
                    var t = _parser2["default"].parse(e),
            ...
            }Object.defineProperty(exports, "__esModule", { value: !0 });var _discoverParent = require("./container-strategies/discover-parent"),
                ...
                _logger2 = _interopRequireDefault(_logger),
                defaultContainerStrategy = new _discoverParent2["default"](_default2["default"]);exports["default"] = GlanceSelector({ containerStrategy: defaultContainerStrategy });
