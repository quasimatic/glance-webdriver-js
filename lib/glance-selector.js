    ...
    (function e(t, n, r) {
        function s(o, u) {
            ...
            function _classCallCheck(e, n) {
                ...
                }return _createClass(e, [{ key: "search", value: function value(e, n, t, i) {
                        t = t || 0;for (var r = e[t], o = r.position - 1, a = [], l = n; l && 0 == a.length;) {
                            a = this.findElement(r.label, l, i), l = l.parentNode;
                        }a = this._limitToVisible(a), a = this._limitToScope(a, n), a = this._limitToNextSibling(a, n);var u = t + 1 === e.length;if (u) return o >= 0 ? a[o] ? [].concat(a[o]) : [] : a;var c = [];if (o >= 0) {
                            var s = a[o],
                                f = this.search(e, s, t + 1, i);c = c.concat(f);
                        } else for (var h = 0; h < a.length; h++) {
                            var s = a[h],
                                f = this.search(e, s, t + 1, i);c = c.concat(f);
                        }return this._unique(c);
                    } }, { key: "_limitToVisible", value: function value(e) {
                        return e.filter(function (e) {
                            return "option" == e.tagName.toLowerCase() || e.offsetParent;
                        });
                    } }, { key: "_limitToScope", value: function value(e, n) {
                        for (var t = !1, i = [], r = 0; r < e.length; ++r) {
                            this._isDescendant(e[r], n) && (t = !0, i.push(e[r]));
                        }return t ? i : e;
                    } }, { key: "_limitToNextSibling", value: function value(e, n) {
                        var t = e.filter(function (e) {
                            return console.log("sibcheck:", n, n.nextElementSibling, n.nextElementSibling == e), n && n.nextElementSibling == e;
